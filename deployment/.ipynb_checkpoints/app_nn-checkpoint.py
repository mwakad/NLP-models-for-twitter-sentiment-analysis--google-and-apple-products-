...
# --- Load models ---
product_model = joblib.load("/deployment/logistic_model.joblib")
vectorizer = joblib.load("/deployment/tfidf_vectorizer.joblib")
sentiment_model = load_model("/deployment/neural_network.keras")
